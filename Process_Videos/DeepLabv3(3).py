...
model.load_state_dict(torch.load('C:/Users/alex1/Desktop/Ahmad_Stuff/Code/Project1/weights/segmentation/DeepLabv3ONE/deeplabv3(3).pth', map_location=torch.device('cuda' if torch.cuda.is_available() else 'cpu')))
model.eval()
...
output_video_path = 'C:/Users/alex1/Desktop/Ahmad_Stuff/Code/Project1/Output_Video/DeepLab2_Far_images.avi'  # Replace with the path to save the output video
