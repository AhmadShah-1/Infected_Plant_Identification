...
train_dataset = SegmentationDataset(
    '/Training_Images/Health_Infected_Leaves_With_Masks/images',
    '/Training_Images/Health_Infected_Leaves_With_Masks/masks',
...
# Save the model
torch.save(model.state_dict(), '/weights/segmentation/DeepLabv3ONE/deeplabv3_custom_model_with_farDistance.pth')
