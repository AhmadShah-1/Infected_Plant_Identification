...
model.load_state_dict(
    torch.load('/weights/segmentation/DeepLabv3ONE/deeplabv3_temp.pth', map_location=torch.device('cuda' if torch.cuda.is_available() else 'cpu')))
model.eval()
...
# Example usage
directory_path = '../../../Training_Images/Only_Far_Images/images'  # Replace with the path to your directory
